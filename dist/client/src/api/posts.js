...
exports.removePost = exports.getSubCommentLikes = exports.getCommentLikes = exports.getPostLikes = exports.likeComment = exports.createAction = exports.createComment = exports.getComments = exports.getImages = exports.createPost = exports.getPosts = void 0;
...
exports.createAction = (0, toolkit_1.createAsyncThunk)(`/posts/:postid/like~{POST}`, ({ a, postid, t }) => (0, req_1.default)(`/posts/${postid}/${t}`, a ? "POST" : "DELETE"));
