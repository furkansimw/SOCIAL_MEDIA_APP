...
`,wu=({quit:e,postid:t,commentid:n,subcommentid:r,type:i})=>{const[o,a]=S.useState(!0),[s,l]=S.useState(!0),[c,d]=S.useState([]);S.useEffect(()=>{const g=x=>{x.key=="Escape"&&e()};return window.addEventListener("keydown",g),()=>{window.removeEventListener("keydown",g)}},[]);const u=g=>{d([...c,...g]),l(g.length==1),a(!1)};S.useEffect(()=>{i=="post"?Wv({postid:t}).then(u):i=="comment"?Gv({postid:t,commentid:n}).then(u):Vv({postid:t,commentid:n,subcommentid:r}).then(u)},[]);const p=g=>{const{created:x,id:b}=c[c.length-1];if(o||!s)return;const{scrollTop:C,clientHeight:E,scrollHeight:P}=g.target;C+E+40>P&&(a(!0),i=="post"?Wv({postid:t,id:b,date:x}).then(u):i=="comment"?Gv({postid:t,commentid:n,id:b,date:x}).then(u):Vv({postid:t,commentid:n,subcommentid:r,id:b,date:x}).then(u))},h=g=>g==null?"Follow":g==0?"Following":g==1?"Requested":"",{username:v}=se(Kt,ue),[y,w]=S.useState({active:!1,process:()=>{},data:{pp:null,username:""}}),m=g=>{const{status:x,ispublic:b,username:C,id:E,pp:P}=g;if(x==null){fo(E,!0);const T=c.map(I=>I.username==C?{...I,status:b?0:1}:I);d(T)}else{fo(E,!1);const T=()=>{const I=c.map(O=>O.username==C?{...O,status:b?0:1}:O);d(I)};b?T():w({active:!0,data:{username:C,pp:P},process:T})}};return f.jsxs(f.Fragment,{children:[f.jsx(zP,{onClick:e}),f.jsxs(FP,{children:[f.jsxs("div",{className:"headerxxx",children:[f.jsx("p",{children:"Likes"}),f.jsx("button",{onClick:e,children:f.jsx(qx,{})})]}),y.active&&f.jsx(xu,{data:y.data,close:()=>w({...y,active:!1}),process:y.process}),f.jsxs("ul",{onScroll:p,className:"contentx",children:[c.map(g=>f.jsxs("li",{children:[f.jsx(Ct,{className:"pp",to:`/${g.username}`,children:f.jsx("img",{onContextMenu:Wr,src:g.pp||"/pp.jpg",alt:"pp"})}),f.jsxs("div",{className:"text",children:[f.jsx(Ct,{to:`/${g.username}`,children:f.jsx("p",{className:"username",children:g.username})}),g.fullname&&f.jsx("p",{className:"fullname",children:g.fullname})]}),g.username!=v&&f.jsx("button",{className:h(g.status),onClick:()=>m(g),children:h(g.status)})]})),o&&f.jsx(Qt,{})]})]})]})},zP=ae.div`
  background-color: rgba(0, 0, 0, 0.5);
  width: 200vw;
  height: 200vh;
  position: fixed;
...
`,D6=({comment:e,reply:t})=>{const n=We(),{id:r,username:i,pp:o,likecount:a,subcommentcount:s,content:l,isliked:c,created:d,subcomments:{data:u,hasmore:p,t:h,loading:v}}=e,y=window.location.pathname.split("/")[2],w=se(To,ue),m=()=>{if(!w)return n(Ze());n(po({a:!c,commentid:r,postid:y}))},g=S.useMemo(()=>Po(d),[]),x=()=>t(r,i),b=()=>{var H,X;const N=(H=u[u.length-1])==null?void 0:H.created,L=(X=u[u.length-1])==null?void 0:X.id;p&&s>0?n(Ha({postid:y,commentid:r,date:N,id:L})):n(DP({postid:y,commentid:r,t:!h}))},C=S.useMemo(()=>(new Date(Date.now()).getTime()-new Date(d).getTime())/1e3<1,[]),E=()=>{if(!w)return n(Ze());c||n(po({a:!0,commentid:r,postid:y}))},[P,T]=S.useState(!1),I=()=>{if(!w)return n(Ze());T(!0)},O=()=>T(!1),[D,j]=S.useState(!1);return f.jsxs(j6,{className:C?"lastactive":"",children:[f.jsx("div",{className:"left",onDoubleClick:E,children:f.jsx("div",{className:"pp",children:f.jsx(Ct,{className:"u",to:`/${i}`,children:f.jsx("img",{src:o||"/pp.jpg",alt:"pp"})})})}),f.jsxs("div",{className:"right",children:[f.jsxs("div",{className:"upside",onDoubleClick:E,children:[f.jsxs("pre",{children:[f.jsx(Ct,{className:"username",to:`/${i}`,children:i}),f.jsx(Lu,{text:l})]}),f.jsx("button",{onClick:m,className:c?"active":"",children:f.jsx(Vx,{isactive:c})}),P&&f.jsx(wu,{postid:y,type:"comment",commentid:r,quit:O})]}),f.jsxs("div",{className:"down-side",onDoubleClick:E,children:[a>0&&f.jsxs("button",{onClick:I,className:"likes",children:[a," like",a>1&&"s"]}),f.jsx("p",{className:"date",children:g}),f.jsx("button",{className:"reply",onClick:x,children:"Reply"}),f.jsx("button",{className:"more",onClick:()=>j(!0),children:f.jsx($h,{})}),D&&f.jsx(yS,{process:()=>n(tm({commentid:r,postid:y})),close:()=>j(!1),data:e})]}),s>0&&f.jsxs("ul",{className:"view-replies",children:[f.jsxs("div",{className:"up",children:[f.jsxs("button",{onClick:b,children:[f.jsx("div",{className:"line"}),h&&!p?f.jsx("p",{children:"Hide Replies"}):f.jsxs("p",{children:["View replies (",p?s-u.length:s,")"]})]}),v&&f.jsx(Qt,{})]}),(p?u.length>0:h)&&u.map(N=>f.jsx(I6,{subcomment:N,commentid:r,reply:()=>t(e.id,N.username)},N.id))]})]})]})},j6=ae.li`
  display: flex;
  align-items: start;
  width: 100%;
  border-radius: 6px;
...
`,N6=S.forwardRef(({reply:e},t)=>{const n=S.useRef(null),r=S.useRef(null),i=We(),o=window.location.pathname.split("/")[2],{comments:{data:a,loading:s,hasmore:l}}=se(pi,ue),c=u=>{var y,w;const{scrollTop:p,clientHeight:h,scrollHeight:v}=u.target;s||!l||h+p>v-132&&i(Ha({postid:o,id:(y=a[a.length-1])==null?void 0:y.id,date:(w=a[a.length-1])==null?void 0:w.created}))};S.useImperativeHandle(t,()=>({dataContainerRef:n,contentRef:r}));const d=se(ko,ue);return f.jsxs(R6,{ref:n,onScroll:c,className:d==null?"backnone":"",children:[f.jsx(L6,{ref:r}),a.map(u=>f.jsx(D6,{comment:u,reply:e},u.id)),s&&f.jsx(Qt,{})]})}),R6=ae.ul`
...
`,L6=S.forwardRef((e,t)=>{const{pp:n,username:r,content:i,created:o}=se(pi,ue),a=S.useMemo(()=>Po(o),[]);return f.jsxs("div",{ref:t,className:"content",children:[f.jsx("div",{className:"pp",children:f.jsx(Ct,{to:`/${r}`,children:f.jsx("img",{src:n||"/pp.jpg",alt:"pp"})})}),f.jsxs("div",{className:"text",children:[f.jsxs("pre",{children:[f.jsx(Ct,{className:"username",to:`/${r}`,children:r}),i&&f.jsx(Lu,{text:i})]}),f.jsx("p",{children:a})]})]})}),M6=(e,t,n)=>{if(!e)return;let r=e.scrollTop;const i=t-r,o=performance.now(),a=s=>{const l=s-o,c=Math.min(l/n,1),d=r+i*c;e.scrollTop=d,l<n&&e.scrollTop!==t&&requestAnimationFrame(a)};requestAnimationFrame(a)},_6=()=>{const e=We(),t=window.location.pathname.split("/")[2],{comments:{hasmore:n,data:r,sending:i}}=se(pi,ue);S.useEffect(()=>{n&&r.length==0&&e(Ha({postid:t}))},[t]);const[o,a]=S.useState(""),s=S.useRef(null),[l,c]=S.useState(null),[d,u]=S.useState(!1);S.useEffect(()=>{u(!0)},[]);const p=(x,b)=>{var C,E;a(`@${b} `),c({commentid:x,username:b,offset:((C=w.current)==null?void 0:C.scrollTop)||0}),(E=s.current)==null||E.focus()};S.useEffect(()=>{d&&(i||(y(l?h:g.current.contentRef.current.clientHeight||0),a("")))},[i]),S.useEffect(()=>{if(l){const{username:x}=l;o.slice(0,x.length+2)!=`@${x} `&&(c(null),a(""))}},[o]);const[h,v]=S.useState(0),y=x=>M6(g.current.dataContainerRef.current,x,500),w=S.useRef(null),m=S.useRef(null),g=S.useRef({dataContainerRef:w,contentRef:m});return S.useEffect(()=>{var b;if(l&&g.current.dataContainerRef.current){var x=Array.from(g.current.dataContainerRef.current.children);x=x.slice(1);const C=r.findIndex(P=>P.id==l.commentid);let E=0;for(let P=0;P<=C;P++)E+=x[P].clientHeight;v(E+((b=g.current.contentRef.current)==null?void 0:b.clientHeight))}},[r,l]),f.jsxs($6,{className:"c",children:[f.jsx(k6,{}),f.jsx(N6,{reply:p,ref:g}),f.jsx(UP,{ref:s,comment:o,setComment:a,isRepliying:l})]})},$6=ae.div`
  width: 100%;
  min-width: 240px;
  max-width: 400px;
  height: 100%;
...
`,ZL=({info:e})=>{const{username:t}=se(Kt,ue),{username:n,ispublic:r,status:i}=e,o=se(To,ue),a=We(),s=()=>a(Ze());return n==t?null:i!=0&&!r?f.jsx("div",{className:"priv",children:o?f.jsxs(f.Fragment,{children:[f.jsx("p",{children:"This Account is Private"}),f.jsx("p",{children:" Follow to see their photos."})]}):f.jsxs(f.Fragment,{children:[f.jsxs("p",{children:["This Account is Private Already follow",f.jsx("span",{className:"us",children:n})]}),f.jsxs("p",{children:[f.jsx("span",{onClick:s,children:"Log in"})," to see their photos."]})]})}):null},JL=({quit:e,type:t,userid:n})=>{const[r,i]=S.useState(!0),[o,a]=S.useState(!0),[s,l]=S.useState([]);S.useEffect(()=>{const y=w=>{w.key=="Escape"&&e()};return window.addEventListener("keydown",y),()=>{window.removeEventListener("keydown",y)}},[]),S.useEffect(()=>{Hv(n,t).then(y=>{l(y),a(y.length==12)}).catch(()=>a(!1)).finally(()=>i(!1))},[]);const c=y=>{const{created:w,rid:m}=s[s.length-1];if(r||!o)return;const{scrollTop:g,clientHeight:x,scrollHeight:b}=y.target;g+x+40>b&&(i(!0),Hv(n,t,{date:w,id:m}).then(C=>{l([...s,...C]),a(C.length==12)}).catch(()=>a(!1)).finally(()=>i(!1)))},d=y=>y==null?"Follow":y==0?"Following":y==1?"Requested":"",{username:u}=se(Kt,ue),[p,h]=S.useState({active:!1,process:()=>{},data:{pp:null,username:""}}),v=y=>{const{status:w,ispublic:m,username:g,id:x,pp:b}=y;if(w==null){fo(x,!0);const C=s.map(E=>E.username==g?{...E,status:m?0:1}:E);l(C)}else{fo(x,!1);const C=()=>{const E=s.map(P=>P.username==g?{...P,status:m?0:1}:P);l(E)};m?C():h({active:!0,data:{username:g,pp:b},process:C})}};return f.jsxs(f.Fragment,{children:[f.jsx(e3,{onClick:e}),f.jsxs(t3,{children:[f.jsxs("div",{className:"headerxxx",children:[f.jsx("p",{children:t}),f.jsx("button",{onClick:e,children:f.jsx(qx,{})})]}),p.active&&f.jsx(xu,{data:p.data,close:()=>h({...p,active:!1}),process:p.process}),f.jsxs("ul",{onScroll:c,className:"contentx",children:[s.map(y=>f.jsxs("li",{children:[f.jsx(Ct,{onClick:e,className:"pp",to:`/${y.username}`,children:f.jsx("img",{onContextMenu:Wr,src:y.pp||"/pp.jpg",alt:"pp"})}),f.jsxs("div",{className:"text",children:[f.jsx(Ct,{onClick:e,to:`/${y.username}`,children:f.jsx("p",{className:"username",children:y.username})}),y.fullname&&f.jsx("p",{className:"fullname",children:y.fullname})]}),y.username!=u&&f.jsx("button",{className:d(y.status),onClick:()=>v(y),children:d(y.status)})]},y.rid)),r&&f.jsx(Qt,{})]})]})]})},e3=ae.div`
  background-color: rgba(0, 0, 0, 0.5);
  width: 200vw;
  height: 200vh;
  position: fixed;
